...
class GroupServiceDeprecatedImpl @Inject()(val keystoreConnector: KeystoreConnector,
                                           val compRegConnector: CompanyRegistrationConnector,
                                           val incorpInfoConnector: IncorpInfoConnector) extends GroupServiceDeprecated


trait GroupServiceDeprecated extends CommonService with SCRSExceptions {
